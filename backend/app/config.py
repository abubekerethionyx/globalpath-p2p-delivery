...
class Config:
    # Use absolute path for SQLite to avoid issues on different hosting environments
    ...
    # Chapa Configuration
    BACKEND_BASE_URL = os.environ.get('BACKEND_BASE_URL') or 'https://globalpathnewapi.peakstartgc.com'
    FRONTEND_BASE_URL = os.environ.get('FRONTEND_BASE_URL') or 'https://globalpath.peakstartgc.com'
